...
.Polaris-Banner--withinPage_kguwn::after { content: ''; position: absolute; z-index: 1; top: -0.0625rem; right: -0.0625rem; bottom: -0.0625rem; left: -0.0625rem; display: block; pointer-events: none; box-shadow: 0 0 0 -0.0625rem var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: var(--p-border-radius-2); }
...
.Polaris-Banner__SecondaryAction_1dl4i:focus-visible > .Polaris-Banner__Text_yj3uv { padding: var(--p-space-05) var(--p-space-1); margin: calc(var(--p-space-05)*-1) calc(var(--p-space-1)*-1); background: transparent; border-radius: var(--p-border-radius-base); box-shadow: none; text-decoration: underline; }
...
.Polaris-Banner__SecondaryAction_1dl4i:focus-visible > .Polaris-Banner__Text_yj3uv::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }

.Polaris-Banner__SecondaryAction_1dl4i:visited { color: inherit; }

.Polaris-Banner__Text_yj3uv { position: relative; }

.Polaris-Banner__Text_yj3uv::after { content: ''; position: absolute; z-index: 1; top: -0.0625rem; right: -0.0625rem; bottom: -0.0625rem; left: -0.0625rem; display: block; pointer-events: none; box-shadow: 0 0 0 -0.0625rem var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: var(--p-border-radius-1); }
...
.Polaris-Banner__Button_r99lw:focus-visible { box-shadow: var(--p-shadow-button); outline: 0; }

.Polaris-Banner__Button_r99lw:focus-visible::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }
...
.Polaris-Banner__Button_r99lw::after { content: ''; position: absolute; z-index: 1; top: -0.1875rem; right: -0.1875rem; bottom: -0.1875rem; left: -0.1875rem; display: block; pointer-events: none; box-shadow: 0 0 0 -0.1875rem var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: var(--p-border-radius-1); }
