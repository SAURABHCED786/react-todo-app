...
const Banner = /*#__PURE__*/React.forwardRef(function Banner({
  ...
  if (title) {
    headingMarkup = /*#__PURE__*/React__default["default"].createElement(Text.Text, {
      as: "h2",
      variant: "headingMd"
    }, title);
  }
  ...
  const primaryActionMarkup = action ? /*#__PURE__*/React__default["default"].createElement(Box.Box, {
    paddingInlineEnd: "2"
  ...
  const actionMarkup = action || secondaryAction ? /*#__PURE__*/React__default["default"].createElement(Box.Box, {
  ...
  if (children || actionMarkup) {
    contentMarkup = /*#__PURE__*/React__default["default"].createElement(Box.Box, {
  ...
  return /*#__PURE__*/React__default["default"].createElement(bannerContext.BannerContext.Provider, {
    ...
    onKeyUp: handleKeyUp,
    onBlur: handleBlur
  }, dismissButton, /*#__PURE__*/React__default["default"].createElement(Box.Box, {
    paddingInlineEnd: "4"
