...
function Header({
  ...
  const breadcrumbMarkup = Array.isArray(breadcrumbs) && breadcrumbs.length > 0 || !Array.isArray(breadcrumbs) && breadcrumbs ? /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  const headerClassNames = css.classNames(Header$1["default"].Header, isSingleRow && Header$1["default"].isSingleRow, titleHidden && Header$1["default"].titleHidden, navigationMarkup && Header$1["default"].hasNavigation, actionMenuMarkup && Header$1["default"].hasActionMenu, isNavigationCollapsed && Header$1["default"].mobileView, !breadcrumbMarkup && Header$1["default"].noBreadcrumbs, title && title.length < LONG_TITLE && Header$1["default"].mediumTitle, title && title.length > LONG_TITLE && Header$1["default"].longTitle);
  const {
    slot1,
    slot2,
    slot3,
