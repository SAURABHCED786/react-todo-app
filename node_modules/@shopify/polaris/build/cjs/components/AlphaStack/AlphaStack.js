...
const AlphaStack = ({
  ...
  const className = css.classNames(AlphaStack$1["default"].AlphaStack, fullWidth && AlphaStack$1["default"].fullWidth, as === 'ul' && AlphaStack$1["default"].listReset, as === 'fieldset' && AlphaStack$1["default"].fieldsetReset);
  const style = {
