@charset "UTF-8";
:root { --polaris-version-number: '10.22.0'; }
...
.Polaris-Button:focus-visible { box-shadow: var(--p-shadow-button); outline: 0; }
...
.Polaris-Button--destructive.Polaris-Button--outline:focus-visible { border: var(--p-border-width-1) solid var(--p-border); box-shadow: none; }

.Polaris-Button--destructive.Polaris-Button--outline:focus-visible::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }
...
.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--destructive:focus-visible { border: var(--p-border-width-1) solid var(--p-border-critical); }

.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--destructive:focus-visible::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }
...
.Polaris-Tooltip-TooltipOverlay { --pc-tooltip-overlay-offset: var(--p-space-1); margin: var(--pc-tooltip-overlay-offset) var(--p-space-4) var(--p-space-4); opacity: 1; box-shadow: var(--p-shadow-popover); pointer-events: none; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: opacity, left, top; transition: opacity var(--p-duration-200) var(--p-ease-in) var(--p-duration-100); }
...
.Polaris-Banner__SecondaryAction:focus-visible > .Polaris-Banner__Text { padding: var(--p-space-05) var(--p-space-1); margin: calc(var(--p-space-05)*-1) calc(var(--p-space-1)*-1); background: transparent; border-radius: var(--p-border-radius-base); box-shadow: none; text-decoration: underline; }
...
.Polaris-Banner__Button:focus-visible { box-shadow: var(--p-shadow-button); outline: 0; }
...
.Polaris-RadioButton__Input:focus-visible + .Polaris-RadioButton__Backdrop::after { border-radius: var(--p-border-radius-half); }
...
.Polaris-ChoiceList__ChoiceChildren { padding-left: calc(var(--p-space-2) + var(--p-choice-size)); }
...
.Polaris-Frame__Skip > a:focus-visible { box-shadow: var(--p-shadow-button); outline: 0; }
...
.Polaris-Navigation__ItemInnerWrapper { position: relative; display: flex; flex-wrap: nowrap; width: 100%; border-radius: var(--p-border-radius-1); }
...
.Polaris-Navigation__ItemWithFloatingActions { position: relative; }
